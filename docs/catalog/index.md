...
applies_to: Iceberg REST v1 / Polaris 1.3-incubating / Gravitino 1.0+ (TLP) / Unity Catalog OSS 0.x / AWS Glue / Snowflake Open Catalog / Hive 4.0
...
!!! warning "读这一章前先理清四层 · 否则很容易选错"
    ...
    **读者最容易的 3 个踩坑**：
    1. 以为 **Apache Polaris OSS ≈ Snowflake Open Catalog** —— 不是（孵化 vs 商业 SLA 天差地别）
    2. 以为 **UC OSS ≈ Databricks UC 商业版** —— 不是（OSS 仅核心 API，治理高级功能仍商业独占）
    3. 以为 **Polaris / Unity / Nessie 在同一赛道横比** —— 不是（**Polaris 偏协议实现 · Unity 偏治理平台 · Nessie 偏版本化**）
...
- [Apache Polaris](polaris.md) —— **Iceberg REST 服务端实现** · Snowflake 开源 · 2026-Q2 仍孵化
