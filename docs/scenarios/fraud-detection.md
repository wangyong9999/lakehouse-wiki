...
!!! info "本节定位 · 场景切面"
    不重复公司全栈（见 [cases/](../cases/index.md)）· 分析 2 家在**欺诈/风控场景**的独特做法。
...
**规模** `[来源未验证 · 量级参考]`：在线 ML 决策**数十亿 / 日** · 欺诈场景 p99 **sub-second**。
