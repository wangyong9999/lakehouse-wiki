...
- [0001 选择 MkDocs Material 作为 Wiki 框架](0001-mkdocs-material.md)
...
- 0004 Catalog 选型（Unity / Polaris / 自建）
- 0005 查询引擎组合（Trino + Spark + StarRocks）
- 0006 Embedding 模型基线（BGE-v2-m3 + SigLIP）
- 0007 Rerank 基线
- 0008 Feature Store 方案
