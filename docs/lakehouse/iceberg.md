...
related: [lake-table, snapshot, manifest, schema-evolution, paimon, delta-lake, hudi, iceberg-v3, puffin]
...
**选型指引**：新项目可直接上 v3（Spark 4.0+ 栈尤其推荐 · Iceberg 1.10.0+ 是 spec 定稿后的首个稳定版本）；混合引擎环境先确认**消费侧 reader 都已升级**——老 reader 读 v3 表会失败。v2 / v3 长期共存（2025-2027）是现实 · 不是短期过渡。**v3 五大能力深度（Deletion Vectors · Row Lineage · Multi-Table Transaction · Geo · Variant）· 兼容矩阵 · 采用决策** → [Iceberg v3 · spec 演进与采用](iceberg-v3.md)。
