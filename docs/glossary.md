...
- **Contextual Retrieval** —— 见 [RAG 前沿](frontier/rag-advances-2025.md)
- **CRAG（Corrective RAG）** —— 见 [RAG 前沿](frontier/rag-advances-2025.md)
...
- **HyDE** —— 见 [RAG 前沿](frontier/rag-advances-2025.md)
...
- **Self-RAG** —— 见 [RAG 前沿](frontier/rag-advances-2025.md)
