...
- **Agentic RAG** —— 见 [RAG 前沿](ai-workloads/rag.md)
- **Agents on Lakehouse** —— 见 [Agents](ai-workloads/agents-on-lakehouse.md)
- **AI Governance（AI 治理）** —— 见 [AI 治理](ops/compliance.md)
...
- **Binary Embedding** —— 见 [向量检索前沿](retrieval/embedding.md)
...
- **ColBERT / Late Interaction** —— 见 [向量检索前沿](retrieval/embedding.md)
- **Compliance（合规）** —— 见 [合规](ops/compliance.md)
- **Contextual Retrieval** —— 见 [RAG 前沿](ai-workloads/rag.md)
- **CRAG（Corrective RAG）** —— 见 [RAG 前沿](ai-workloads/rag.md)
...
- **Guardrails（LLM 护栏）** —— 见 [AI 治理](ops/compliance.md)
...
- **HyDE** —— 见 [RAG 前沿](ai-workloads/rag.md)
...
- **Matryoshka Embedding** —— 见 [向量检索前沿](retrieval/embedding.md)
...
- **Prompt Injection** —— 见 [AI 治理](ops/compliance.md)
...
- **RAG** —— 见 [RAG](ai-workloads/rag.md) · [前沿 2025](ai-workloads/rag.md)
...
- **Red Teaming** —— 见 [AI 治理](ops/compliance.md)
...
- **Self-RAG** —— 见 [RAG 前沿](ai-workloads/rag.md)
...
- **SPLADE** —— 见 [Hybrid Search](retrieval/hybrid-search.md) · [向量检索前沿](retrieval/embedding.md)
...
- **Vector Trends（向量检索前沿）** —— 见 [向量检索前沿](retrieval/embedding.md)
