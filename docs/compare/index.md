...
- LLM 推理框架对比（vLLM / SGLang / TGI / TensorRT-LLM） —— 现在在 [LLM 推理优化](../frontier/llm-inference-opt.md) 里
- BI 工具对比（Superset / Metabase / Tableau / Looker）
- 数据接入工具对比（Fivetran / Airbyte / Meltano）
