...
→ [LLM Gateway](ml-infra/llm-gateway.md) · [MCP](ai-workloads/mcp.md)
...
→ [Iceberg v3 预览](frontier/iceberg-v3-preview.md)
...
**一定要先建评估集再调**，否则盲飞。
→ [RAG on Lake](scenarios/rag-on-lake.md) · [RAG 前沿 2025](frontier/rag-advances-2025.md)
...
→ [Lakehouse 厂商与开源生态格局](frontier/vendor-landscape.md) · [TCO 模型](ops/tco-model.md)
