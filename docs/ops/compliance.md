...
related: [data-governance, security-permissions, model-registry]
status: stable
---
...
**法规面广不等于都做**。工程团队容易被"合规焦虑"吓退 · 关键是**先做什么 · 后做什么 · 什么只在触发时做**。
...
| Week 4 | **权限最小化** + Access Review 节奏（见 [security-permissions](security-permissions.md)）| 季度 review SOP |
